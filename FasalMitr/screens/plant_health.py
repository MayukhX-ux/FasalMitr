...
from ai.plant_health import ml_analyse_plant_image

class PlantHealth(Screen):
    def __init__(self, **kwargs):
        super(PlantHealth, self).__init__(**kwargs)
        self.layout = BoxLayout(orientation='vertical', padding=20, spacing=10)
        self.layout.add_widget(Label(text='Plant Health Checkup', font_size=28))
    ...
    def run_analysis(self, instance):
        if self.img_path:
            result = ml_analyse_plant_image(self.img_path)
